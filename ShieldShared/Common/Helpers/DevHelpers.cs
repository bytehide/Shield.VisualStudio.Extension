...
static class DevHelpers
{
    ...
    public static IEnumerable<NodeT> SortTopologically<NodeT>(this IEnumerable<NodeT> roots,
        Func<NodeT, IEnumerable<NodeT>> edges)
    {
    ...
    public static IEnumerable<NodeT> SortTopologicallyReverse<NodeT>(this IEnumerable<NodeT> roots,
        Func<NodeT, IEnumerable<NodeT>> edges)
    {
    ...
    static void AddNode<NodeT>(ICollection<NodeT> list, HashSet<NodeT> marked, NodeT node,
        Func<NodeT, IEnumerable<NodeT>> edges)
    {
        if (!marked.Add(node))
            return;
