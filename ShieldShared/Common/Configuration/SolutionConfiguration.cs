...
public class SolutionConfiguration
{
    ...
    [DefaultValue("Release")] public string BuildConfiguration { get; set; } = "Release";

    public string ShieldProjectName { get; set; }

    [DefaultValue(true)] public bool CreateShieldProjectIfNotExists { get; set; } = true;
    [DefaultValue(true)] public bool FindCustomConfigurationFile { get; set; } = true;
    ...
    [JsonPropertyName("Projects")] public List<ProjectConfiguration> Projects { get; set; } = [];
